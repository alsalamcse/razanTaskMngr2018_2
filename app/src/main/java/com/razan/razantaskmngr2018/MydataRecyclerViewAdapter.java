...
import com.razan.razantaskmngr2018.dataFragment.OnListFragmentInteractionListener;
...
public class MydataRecyclerViewAdapter extends RecyclerView.Adapter<MydataRecyclerViewAdapter.ViewHolder> {
    ...
    public MydataRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
